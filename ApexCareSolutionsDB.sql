...
VALUES 
    ('John Doe', 'john.doe@example.com', '555-1234', '123 Main St', 'Password123!'),
    ('Jane Smith', 'jane.smith@example.com', '555-5678', '456 Oak Ave', 'SecurePass456@'),
    ('Bob Johnson', 'bob.johnson@example.com', '555-9876', '789 Pine Rd', 'MyPassword789#');
